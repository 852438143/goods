  ...
  <body>
    ...
    <c:forEach items="${parents}" var="parent">
    	<tr class="trOneLevel">
    		...
    		<td>${parent.desc}</td>
    		<td width="200px;">
    		  <a href="<c:url value='/admin/AdminCategoryServlet?method=addChildPrepare&cid=${parent.cid}&cname=${parent.cname}'/>">添加二级分类</a>
    		  <a href="<c:url value='/admin/AdminCategoryServlet?method=editParentPrepare&cid=${parent.cid}'/>">修改</a>
    	...
    	<tr class="trTwoLevel">
    		...
    		<td width="200px;" align="right">
    		  <a href="<c:url value='/admin/AdminCategoryServlet?method=editChildPrepare&cid=${child.cid}&pid=${parent.cid}'/>">修改</a>
